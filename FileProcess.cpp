...
CString   GetNextFileName_1(CString strFileCurrent)
{
	int  nCurrentFileNumber;
	CString strFileNext;
	if (!GetFileNumber(strFileCurrent,nCurrentFileNumber))
	{
		strFileNext="^()^";
		return strFileNext;
	}	
	...
	strFileNext = strFileCurrent;
	ResetCurrentFileNameFromNumber( strFileNext , nCurrentFileNumber);
	return strFileNext;  
}
CString   GetNextFileName_123(CString strFileCurrent)
{
	int  nCurrentFileNumber;
	CString strFileNext;
	if (!GetFileNumber(strFileCurrent,nCurrentFileNumber))
...
CString   GetPreFileName_1(CString strFileCurrent)
{
	int  nCurrentFileNumber;
	CString strFileNext;
	if (!GetFileNumber(strFileCurrent,nCurrentFileNumber))
...
CString   GetPreFileName_123(CString strFileCurrent)
{
	int  nCurrentFileNumber;
	CString strFileNext;
	if (!GetFileNumber(strFileCurrent,nCurrentFileNumber))
